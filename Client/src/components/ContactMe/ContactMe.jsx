  ...
  return (
    <div>
      <div className="myPortfolioWrapper">
        ...
        <h1 className="myResume">Contact Me</h1>
                ...
                <div class="container-fluid text-center">
                  <div class="row">
                    <div class="col">
                      ...
                      <a
                        href="http://gitlab.perryville.perseverenow.org/abrooks "
                        target="_blank"
                      >
                        <svg
                      ...
                      <a href=""  target="_blank">
                        <svg
                          ...
                          height="40"
                          fill="currentColor"
                          className="bi bi-facebook icon bs-link-hover-color:#0a56ca"
                          viewBox="0 0 16 16"
                        >
